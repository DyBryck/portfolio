...
const CardSkills = () => {
  return (
    <div className="col-span-6 flex flex-col items-center justify-center rounded-lg bg-white/20 shadow-xl backdrop-blur-xl transition-all duration-500 hover:scale-105 md:col-span-3 md:row-span-1 lg:col-span-3 lg:row-span-2 xl:col-span-2 xl:row-span-1 dark:bg-black/20">
