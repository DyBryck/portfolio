const CardMail = () => {
  return (
    <div className="col-span-3 row-span-1 flex items-center justify-center rounded-lg bg-white/20 shadow-lg backdrop-blur-xl transition-all duration-500 hover:scale-105 hover:opacity-100 md:col-span-1 md:row-span-2 md:opacity-80 lg:col-span-1 lg:row-span-1">
      <a
