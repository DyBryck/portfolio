...
const Modal = ({ project, onClose }) => {
  ...
  return (
    ...
    >
      <div
        className={`relative flex h-full max-h-[600px] w-full max-w-7xl transform flex-col items-center justify-center overflow-hidden rounded-lg shadow-xl backdrop-blur-xl transition-all duration-500 md:max-h-[800px] md:flex-col lg:flex-row ${
      ...
      >
        ...
        <div className="flex h-full w-full flex-col justify-center overflow-scroll bg-white/70 p-4 md:h-2/6 lg:h-full lg:w-2/6 xl:p-12">
