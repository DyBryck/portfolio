const CardCV = () => {
  return (
    <div className="col-span-3 row-span-2 flex flex-col items-center justify-around overflow-hidden rounded-lg bg-white/10 opacity-80 shadow-xl backdrop-blur-xl transition-all duration-500 hover:scale-105 hover:opacity-100 md:col-span-2 md:row-span-3 lg:col-span-3 lg:row-span-1 lg:flex-row xl:col-span-1 xl:row-span-2 xl:flex-col">
