const CardCV = () => {
  return (
    <div className="col-span-2 row-span-2 flex flex-col items-center justify-around overflow-hidden rounded-lg bg-white/20 shadow-xl backdrop-blur-xl transition-all duration-500 hover:scale-105 hover:opacity-100 md:col-span-3 md:row-span-1 md:flex-row md:opacity-80 lg:col-span-3 lg:row-span-1 lg:flex-row xl:col-span-2 xl:row-span-1 dark:bg-black/20">
