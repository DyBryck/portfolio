...
const CardSection = ({ title, image, content }) => {
  return (
    <div className="group col-span-8 row-span-3 flex flex-col items-center justify-around rounded-lg bg-white/20 p-6 shadow-xl backdrop-blur-xl transition-all duration-500 hover:scale-105 md:col-span-4 lg:row-span-3 xl:row-span-2 dark:bg-black/20">
